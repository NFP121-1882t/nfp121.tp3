...
public class Pile4Test extends junit.framework.TestCase {
    ...
    public void test_Pile_equals() throws Exception {
        ...
        assertTrue("ÈgalitÈ de deux piles ? ", p3.equals(p4));
        assertTrue("ÈgalitÈ de deux piles ? ", p4.equals(p3));
        assertTrue("ÈgalitÈ de deux piles ? ", p2.equals(p3));
        assertTrue("ÈgalitÈ de deux piles ? ", p1.equals(p4));
